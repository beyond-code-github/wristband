...
def test_patched_deploy_exception(mocked_jenkins_service_provider, api_client):
...
@mock.patch('wristband.apps.views.JenkinsServiceProvider')
def test_patched_deploy_success(mocked_jenkins_service_provider, api_client):
