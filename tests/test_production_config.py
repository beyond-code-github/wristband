...
class WristbandconfigTestCase(unittest.TestCase):
    ...
    def test_production_config_mode(self, os_getenv):
        os_getenv.side_effect = lambda environment: {
            ...
            "ENVIRONMENT_qa_zone_one_jenkins_uri": "http://qa-zone_one",
            "ENVIRONMENT_qa_zone_two_jenkins_uri": "http://qa-zone_two",
            "ENVIRONMENT_staging_zone_one_jenkins_uri": "http://staging-zone_one",
            "ENVIRONMENT_staging_zone_two_jenkins_uri": "http://staging-zone_two",
        ...
        self.assertEquals({
            'qa-zone_one': {'jenkins_uri': 'http://qa-zone_one'},
            'qa-zone_two': {'jenkins_uri': 'http://qa-zone_two'},
            'staging-zone_one': {'jenkins_uri': 'http://staging-zone_one'},
            'staging-zone_two': {'jenkins_uri': 'http://staging-zone_two'}
